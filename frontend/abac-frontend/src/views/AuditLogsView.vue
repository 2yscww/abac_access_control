...
const actionOptions = [
  ...
  { value: 'ASSIGN_DEPARTMENT_MANAGER', label: '指定部门负责人' },
...
<template>
  <div class="audit-page">
      <section class="audit-hero">
        <div>
          <p class="audit-hero__eyebrow">Audit Trail</p>
          <h2 class="audit-hero__title">授权决策与业务交接审计</h2>
          <p class="audit-hero__description">
            这里既能看权限放行和拒绝，也能看离职、改派等业务交接事件，是整个系统“可追溯”的证据层。
          </p>
        </div>
      ...
      <el-card shadow="never" class="table-card">
        ...
        <el-empty v-if="!loading && logs.length === 0" description="没有命中当前筛选条件的审计日志" />
